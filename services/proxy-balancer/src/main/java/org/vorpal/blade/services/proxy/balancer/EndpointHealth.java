...
/// dialogs ([InviteCallflow]): a 2xx marks the endpoint up, a 503 marks it down
...
public class EndpointHealth implements Serializable {
	...
	/// One observation: a ping verdict or a passive mark from a live dialog.
	public static class Sample implements Serializable {
		...
		/// "ping" (OPTIONS cycle) or "call" (live INVITE dialog).
	...
	/// Epoch millis of the last observation (ping or live dialog), 0 if never.
	...
	// every dialog-final response is an attempt; 2xx counts a success;
