...
public class MediaFieldParser extends SDPParser {
	 ...
	 * 50012 RTP/AVP 0 8 4 18\n", "m=image 49172 udptl t38\n" };
	 * 
	 * for (int i = 0; i < media.length; i++) { MediaFieldParser
	 * mediaFieldParser=new MediaFieldParser( media[i] );
	 * System.out.println("toParse: " + media[i]); MediaField
	 * mediaField=mediaFieldParser.mediaField(); System.out.println("encoded: "
	 * +mediaField.encode()); }
	 * 
	 * }
	 **/
...
/*
 * $Log: not supported by cvs2svn $ Revision 1.5 2007/02/06 16:40:00 belangery
 * Introduced simple code optimizations.
 *
 * Revision 1.4 2006/07/13 09:02:42 mranga Issue number: Obtained from:
