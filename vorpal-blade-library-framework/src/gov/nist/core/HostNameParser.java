...
public class HostNameParser extends ParserCore {
	...
	/**
	 * Determines whether or not we should tolerate and strip address scope zones
	 * from IPv6 addresses. Address scope zones are sometimes returned at the end of
	 * IPv6 addresses generated by InetAddress.getHostAddress(). They are however
	 * not part of the SIP semantics so basically this method determines whether or
	 * not the parser should be stripping them (as opposed simply being blunt and
	...
	public Host host() throws ParseException {
		...
		// IPv6 address (i.e. missing square brackets)
			...
			hostname = new StringBuilder("[").append(lexer.getBuffer().substring(startPtr, lexer.getPtr())).append("]")
					.toString();
		}
	...
	/**
	 * Tries to determine whether the address in <tt>uriHeader</tt> could be an IPv6
	 * address by counting the number of colons that appear in it.
	 *
	 * @param uriHeader the string (supposedly the value of a URI header) that we
	 *                  have received for parsing.
	 *
	 * @return true if the host part of <tt>uriHeader</tt> could be an IPv6 address
	 *         (i.e. contains at least two colons) and false otherwise.
	 */
	...
	public static void main(String args[]) throws ParseException {
		String hostNames[] = { "foo.bar.com:1234", "proxima.chaplin.bt.co.uk", "129.6.55.181:2345", ":1234",
				"foo.bar.com:         1234", "foo.bar.com     :      1234   ", "MIK_S:1234" };
