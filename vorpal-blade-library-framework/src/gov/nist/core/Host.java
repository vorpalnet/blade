 ...
 **************************************************************************/
/*
 * 2024-04-17 Modified to removed excessive logging. --Jeff McDonald
 */
...
public class Host extends GenericObject {
	...
	/**
	 * Compare for equality of hosts. Host names are compared by textual equality.
	...
	/**
	 * Convenience function to get the raw IP destination address of a SIP message
	 * as a String.
	 * 
	 * @return String
	...
	/**
	 * Get the inet address from this host. Caches the inet address returned from
	 * dns lookup to avoid lookup delays.
	 *
