...
public class SimpleBlockConfig2 extends Configuration {
...
//		public Map<String, Dialed> dialedNumbers = null;
		public List<Dialed> dialedNumbers = null;
...
//	public static String forwardTo(SimpleBlockConfig2 config1, SipServletRequest request) {
