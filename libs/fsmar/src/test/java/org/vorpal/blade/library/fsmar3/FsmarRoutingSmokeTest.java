...
import org.vorpal.blade.framework.v3.fsmar.Diagram;
...
public final class FsmarRoutingSmokeTest {
	...
	private static void testPseudoVariables() {
		...
		AppRouter.publishPseudoVariables(ctx, "INVITE", "sip:bob@example.com", "NEW",
				"NEUTRAL", "core", "null", "a84b4c76e66710@pc33.example.com");
		...
		check("pseudo: region", "NEUTRAL".equals(ctx.resolve("${region}")));
		check("pseudo: regionLabel", "core".equals(ctx.resolve("${regionLabel}")));
		...
		AppRouter.publishPseudoVariables(ctx3, null, null, null, null, null, null, null);
