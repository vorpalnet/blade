...
/// the application sits between two call dialogs and mediates the SIP signaling.
...
/// other dialog. The action depends on the dialog state of the linked session:
///
/// <ul>
...
/// These handle the tedious work of copying SIP message content between call dialogs:
///
/// <table>
...
///       &mdash; retrieves the other dialog's session, or null if this session has no
///       link yet</li>
...
///     <td>Error recovery for connected calls &mdash; sends BYE to both dialogs
...
///       {@code SipSession} (call dialog). Generated by {@link Callflow#createVorpalDialogId}.</li>
/// </ul>
///
...
/// - [CallflowCallConnectedError] - Error cleanup for connected calls (BYE both dialogs)
///
/// ### Utilities
///
