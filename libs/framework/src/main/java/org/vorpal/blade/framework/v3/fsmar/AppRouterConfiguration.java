...
public class AppRouterConfiguration extends Configuration implements Serializable {
	...
	@Override
	@JsonPropertyDescription("FSMAR config schema version (framework-managed). The config filename is un-versioned (fsmar.json) — the version lives here. A pre-3 (FSMAR 2) config is auto-upgraded on load; review and re-save it in the Flow editor.")
