			...
			function validateData(){
				var validated;
	 			if(selectedTab=="data"){
					...
					bf.render(container, JSON.parse(codeMirrors["data"].getValue()));
				}
				
				validated = bf.validate();
...
-->
 ...
 -->
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				...
				<form autocomplete="off" id="bladeForm" name="bladeForm" method="post" action="">
					...
					<div class="panel panel-primary">
						...
						<select class="form-control" value="Cluster" id="examples" onchange="chgAction();this.form.submit()">
							<option value="Domiain">Domain</option>
 ...
 -->
					...
					<div class="panel panel-primary">
						...
						<div class="panel-footer">
							<button id="save" class="btn btn-primary" onclick="saveData( app, configType, JSON.stringify(bf.getData(), null, 4))">Save</button>
							&nbsp;
							<button id="display" type="button" class="btn btn-primary" onclick="alert(JSON.stringify(bf.getData(), null, 4))">Display</button>
							&nbsp;
                            ...
                            <button id="validate" type="button" class="btn btn-primary"
								onclick="validateData()">Validate</button> 
