				...
				<div class="panel-heading" role="tab" id="headingOne">
					<h4 class="panel-title">
						<a role="button" data-toggle="collapse" data-parent="#accordion"
							...
							aria-controls="collapseInput"><%=app%></a>
					</h4>
				</div>
				<div id="collapseInput" class="panel-collapse collapse in"
					role="tabpanel" aria-labelledby="headingOne">
					<div class="panel-body">
						<label for="examples">Configuration:</label> <select
						...
						<ul class="nav nav-tabs" role="tablist">
							...
							<li role="presentation" class="active"><a
								href="index.html#form" aria-controls="form" role="tab"
						...
						<div class="tab-content">
							<div role="tabpanel" class="tab-pane active" id="form"></div>
