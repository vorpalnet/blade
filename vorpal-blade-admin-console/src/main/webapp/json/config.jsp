...
for (String app : apps) {
	...
	appsHtml.append("<li class=\"nav-item\"><a href=\"../json/config.jsp?configType=Domain&app=" + app
...
<link href="../limitless/assets/css/all.min.css" rel="stylesheet" type="text/css">
<!-- /global stylesheets -->

<!-- Core JS files -->
<script src="../limitless/jquery-3.6.0/jquery-3.6.0.min.js"></script>
<script src="../limitless/bootstrap-4.6.0-dist/js/bootstrap.bundle.min.js"></script>
<!-- /core JS files -->
...
function saveData(app, configType, data){
	try {
	  ...
	  // Modify the URL
	  $('#bladeForm').attr('action', $('#bladeForm').attr('action')+'config.jsp?configType='+configType+"&app="+app);
...
<body onload="generateForm()">
	...
	<div class="navbar navbar-expand-lg navbar-dark navbar-static">
		...
		<div class="navbar-brand text-center text-lg-left">
			<a href="config.jsp" class="d-inline-block"> <img src="./global_assets/images/logo_light.png" class="d-none d-sm-block" alt=""> <img
				src="./global_assets/images/logo_icon_light.png" class="d-sm-none" alt="">
			</a>
		</div>
				...
				<div class="sidebar-section sidebar-user">
					<div class="sidebar-section-body d-flex justify-content-center">
						...
						<div class="sidebar-resize-hide flex-1 ml-3">
							...
							<div class="font-size-sm line-height-sm text-muted">Developer Wizard</div>
						</div>
					</div>
				</div>
				<!-- /user menu -->
					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-open nav-item-expanded"><a href="#" class="nav-link"><i class="icon-stack2"></i> <span>Tools</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Tools">
								...
								<li class="nav-item"><a href="../json/config.jsp?configType=Domian&app=b2bua" class="nav-link" target="content_iframe">Configurator</a></li>
						...
						<div class="panel panel-primary">
							...
							<script type="text/javascript">
									...
									<ul class="nav nav-tabs" role="tablist">
										<li role="presentation" class="active"><a href="config.jsp#form" aria-controls="schema" role="tab" data-toggle="tab">Form</a></li>
										<li role="presentation"><a href="config.jsp#data" aria-controls="data" role="tab" data-toggle="tab">JSON</a></li>
										<li role="presentation"><a href="config.jsp#sample" aria-controls="sample" role="tab" data-toggle="tab">Sample</a></li>
										<li role="presentation" class=""><a href="config.jsp#schema" aria-controls="schema" role="tab" data-toggle="tab">Schema</a></li>
									</ul>
									<!-- Tab panes -->
									...
									<div class="alert alert-danger in" role="alert" id="jsonAlert" style="display: none">
										<a href="config.jsp#" onclick='$("#jsonAlert").hide();' class="close">&times;</a> <strong>Error!</strong> <span id="error-message"></span>
									</div>
