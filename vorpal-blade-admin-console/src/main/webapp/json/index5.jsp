...
<script
    ...
    <body>
        <div class="container" >
            <h1><img alt="vorpal-logo" src="./vorpal-logo-small.png" style="padding: 5px 5px 5px 5px; border: 0; height: 80px;"/><code>BLADE</code> Configurator</h1>

            <blockquote>
                <p><b>JSON Schema to HTML form generator</b>, supporting dynamic subschemas (on the fly resolution). Extensible and customizable library with zero dependencies.</p> 
                <p>Source code and documentation available at <a href="https://github.com/vorpalnet/blade"><span class="octicon octicon-logo-github"></span></a></p>
            </blockquote>
