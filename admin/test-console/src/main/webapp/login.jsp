...
<head>
	...
	<title>Sign In · BLADE Test Console</title>
	<link rel="stylesheet" href="/blade/portal/brand/brand.css">
	<link rel="icon" type="image/svg+xml" href="/blade/test-console/favicon.svg">
</head>
<body class="vorpal-login">
	...
	<div class="vorpal-login-stack">
		...
		<div class="vorpal-login-header">
			...
			<p>Test Console · Blended Layer Application Development Environment</p>
		</div>
