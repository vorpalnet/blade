// Runs the log viewer's browser-side tests.
//
...
// touching anything under src/main/webapp.
//
// Exits non-zero on failures, so it can be dropped into a pre-commit hook or
// CI step later without changes.
