...
window.flowUtils = (function() {
	...
	var tooltipsByIcon = {
		...
		'save.svg':              'Save mxGraph XML diagram file (keeps layout)',
		...
		'server-in.svg':         'Add Ingress cloud (incoming calls from outside)',
		'rectangle-landscape.svg':'Add State (BLADE application)',
		'server-out.svg':        'Add Egress cloud (outgoing calls leaving BLADE)',
		'cut.svg':               'Cut',
		'copy.svg':              'Copy',
		'paste.svg':             'Paste',
