...
<head>
	...
	<title>Sign In · BLADE API Explorer</title>
	<link rel="stylesheet" href="/blade/portal/brand/brand.css">
	<link rel="icon" type="image/svg+xml" href="/blade/api/favicon.svg">
</head>
<body class="vorpal-login">
	...
	<div class="vorpal-login-stack">
		...
		<div class="vorpal-login-header">
			...
			<p>API Explorer · Blended Layer Application Development Environment</p>
		</div>
