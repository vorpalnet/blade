...
<head>
	...
	<title>Sign In · BLADE Configurator</title>
	<link rel="stylesheet" href="/blade/portal/brand/brand.css">
	<link rel="icon" type="image/svg+xml" href="/blade/configurator/favicon.svg">
</head>
<body class="vorpal-login">
	...
	<div class="vorpal-login-stack">
		...
		<div class="vorpal-login-header">
			...
			<p>Configurator · Blended Layer Application Development Environment</p>
		</div>
